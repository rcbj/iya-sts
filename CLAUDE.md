...
| Attest a workload — node attestation is verified or refused in every mode since 2026-09-21 (#40: join_token, x509pop, sshpop, tpm_devid), and SPIRE's Kubernetes and cloud attestors and workload attestation are #40's later phases | `spiffe/CLAUDE.md` |
