...
| 8081 HTTPS | The main port: every path-based protocol, `/admin`, `/portal` and `/admin-api` |
| 8443, 9443 HTTPS | The two TLS endpoints: one asks for a client certificate, the other requires one |
